          ...
          children: [
            {
              ...
              requiredPermissions: ['result.view_resultconfigurationgroupmodel'],
            },
            {
              name: 'Field Sets',
              ...
              requiredPermissions: ['result.view_resultfieldsetmodel'],
            },
            {
              name: 'Grade Sets',
              ...
              requiredPermissions: ['result.view_resultgradesetmodel'],
            },
            {
              name: 'Templates',
            ...
            },
            {
              ...
              requiredPermissions: ['result.view_resultbehaviorcategorymodel'],
            },
            {
              name: 'Comments',
              ...
              requiredPermissions: ['result.view_resultcommenttemplatemodel'],
            },
            {
              ...
              requiredPermissions: ['result.view_resulttextcategorymodel'],
            },
          ],
        },
      ],
      ...
      children: [
        {
          ...
          requiredPermissions: ['fee_management.view_feepaymentmodel'],
        },
        {
          name: 'Fee Payment',
          href: '/dashboard/staff/fee/payments/search',
          icon: <CreditCard className="h-4 w-4" />,
          current: isCurrentPath('/dashboard/staff/fee/payments/search'),
          requiredPermissions: ['fee_management.add_feepaymentmodel'],
        },
        {
          name: 'Fee Structures',
          ...
          requiredPermissions: ['fee_management.view_feestructuremodel'],
        },
        {
          name: 'Fees',
          ...
          requiredPermissions: ['fee_management.view_feemodel'],
        },
        {
          name: 'Discounts',
          ...
          requiredPermissions: ['fee_management.view_discountmodel'],
        },
        {
          name: 'Bank Accounts',
          href: '/dashboard/staff/fee/bank-accounts',
          icon: <Building className="h-4 w-4" />,
          current: isCurrentPath('/dashboard/staff/fee/bank-accounts'),
          requiredPermissions: ['fee_management.view_bankaccountmodel'],
        },
        {
          name: 'Gateways',
          href: '/dashboard/staff/fee/gateways',
          icon: <Smartphone className="h-4 w-4" />,
          current: isCurrentPath('/dashboard/staff/fee/gateways'),
          requiredPermissions: ['fee_management.view_paymentgatewaymodel'],
        },
        {
          name: 'Fee Settings',
