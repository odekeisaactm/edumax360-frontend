...
export interface ModuleDef {
  ...
  label: string;
  description: string;
  moduleCode?: string; // Determines if the module requires an active subscription
  areas: AreaDef[];
}
...
export const MODULES: ModuleDef[] = [
  {
    ...
    // Core module - no moduleCode required
    areas: [
      {
        key: 'staff_records',
        label: 'Staff Records',
    ...
    areas: [
      {
        ...
        label: 'Payroll Operations & Disbursements',
        description: 'Manage staff salary profiles, process payroll batches, and handle loans',
        permissions: [
          { codename: 'view_salaryrecordmodel',   label: 'View Payroll Data',     desc: 'Read salary structures, payslips, bonuses, loans, and advances' },
          { codename: 'add_salaryrecordmodel',    label: 'Process Payroll',       desc: 'Assign salary structures to staff and initiate monthly payroll batches' },
          { codename: 'change_salaryrecordmodel', label: 'Approve & Disburse',    desc: 'Approve payrolls, disburse loans/advances, and mark payslips as paid' },
          { codename: 'delete_salaryrecordmodel', label: 'Delete Records',        desc: 'Permanently remove payroll records, structures, or bonuses' },
        ],
      },
      {
        key: 'salary_settings',
        label: 'Global Configuration & Taxes',
        description: 'Manage the core mathematical templates and global payroll behavior',
        permissions: [
          { codename: 'view_salarysettingmodel',   label: 'View Settings',         desc: 'Read global payroll rules, tax brackets, and salary templates' },
          { codename: 'change_salarysettingmodel', label: 'Manage Settings',       desc: 'Update global rules (PDF locks, auto-deductions) and edit tax templates' },
        ],
      }
    ],
  },
  ...
  areas: [
    {
      ...
      permissions: [
        ...
        { codename: 'view_attendancesummarymodel',      label: 'View Term Summaries', desc: 'Read end-of-term attendance summary dashboards' },
      ],
    },
    {
      ...
      permissions: [
        ...
        { codename: 'view_devicecommandqueuemodel', label: 'View Command Queue', desc: 'Monitor pending and executed commands for networked terminals' },
      ],
    },
    {
